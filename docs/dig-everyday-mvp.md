...
OpenAI analysis and feed triage use the lower-cost `OPENAI_MODEL`. Final
Instagram cards and captions use `OPENAI_WRITING_MODEL`, followed by a mandatory
human-tone copy-edit pass and a targeted repair pass when generic AI phrasing
remains.
